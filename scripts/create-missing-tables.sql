-- Create missing database tables for Centomo V2
...
INSERT INTO forms (user_id, patient_name, patient_id, form_type, status) VALUES
  ('00000000-0000-0000-0000-000000000001', 'Jean Dupont', 'P001', 'cnesst', 'completed'),
  ('00000000-0000-0000-0000-000000000001', 'Marie Tremblay', 'P002', 'cnesst', 'draft'),
  ('00000000-0000-0000-0000-000000000001', 'Pierre Gagnon', 'P003', 'cnesst', 'in-progress'),
  ('00000000-0000-0000-0000-000000000001', 'Sophie Martin', 'P004', 'cnesst', 'completed')
ON CONFLICT DO NOTHING;

INSERT INTO exports (form_id, user_id, export_type, status, file_size) VALUES
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'PDF', 'completed', 2400000),
  ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Word', 'completed', 1800000),
  ('00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'PDF', 'processing', NULL)
ON CONFLICT DO NOTHING;
